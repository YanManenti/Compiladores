...
#DECLARACOES
PARSE_TABLE[NONTERMINAL_DICT["DECLARACOES"]][TOKEN_DICT["const"], TOKEN_DICT["var"], TOKEN_DICT["begin"]] = "CONSTANTES VARIAVEIS PROCEDIMENTOS"

#CONSTANTES
PARSE_TABLE[NONTERMINAL_DICT["CONSTANTES"]][TOKEN_DICT["const"]] = "const ident = nint; CONSTANTES"
...
PARSE_TABLE[NONTERMINAL_DICT["LDVAR"]][TOKEN_DICT["begin"], TOKEN_DICT["procedure"]] = "î"
...
#COMANDO
PARSE_TABLE[NONTERMINAL_DICT["COMANDO"]][
    TOKEN_DICT["print"],
    TOKEN_DICT["if"],
    TOKEN_DICT["ident"],
    TOKEN_DICT["for"],
...
#ITEMSAIDA
PARSE_TABLE[NONTERMINAL_DICT["ITEMSAIDA"]][
    TOKEN_DICT["("],
    TOKEN_DICT["ident"],
    TOKEN_DICT["nint"],
    TOKEN_DICT["nreal"],
...
#EXPRESSAO
PARSE_TABLE[NONTERMINAL_DICT["EXPRESSAO"]][
    TOKEN_DICT["("],
    TOKEN_DICT["ident"],
    TOKEN_DICT["nint"],
    TOKEN_DICT["nreal"],
...
PARSE_TABLE[NONTERMINAL_DICT["EXPR"]][TOKEN_DICT["-"]] = "- TERMO EXPR"
PARSE_TABLE[NONTERMINAL_DICT["EXPR"]][
    TOKEN_DICT[")"],
    TOKEN_DICT[","],
    TOKEN_DICT["}"],
    TOKEN_DICT["="],
...
PARSE_TABLE[NONTERMINAL_DICT["TERMO"]][TOKEN_DICT["/"]] = "/ FATOR TER"
PARSE_TABLE[NONTERMINAL_DICT["TERMO"]][
    TOKEN_DICT["+"],
    TOKEN_DICT["-"],
    TOKEN_DICT[")"],
    TOKEN_DICT[","],
...
#EXPRELACIONAL
PARSE_TABLE[NONTERMINAL_DICT["EXPRELACIONAL"]][
    TOKEN_DICT["("],
    TOKEN_DICT["ident"],
    TOKEN_DICT["nint"],
    TOKEN_DICT["nreal"],
